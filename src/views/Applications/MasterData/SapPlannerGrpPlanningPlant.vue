...
export default {
  ...
  methods: {
    ...
    FETCH_LIST() {
      GET_DATA(this, '/Md/get-md-sap-planner-grp-planning-plant-list', 'dataList');
    },
    CREATE(e) {
      e.data.id = 0;
      POST_DATA('/Md/add-md-sap-planner-grp-planning-plant', e.data, () => { this.FETCH_LIST(); });
    },
    UPDATE(e) {
      PUT_DATA(`/Md/edit-md-sap-planner-grp-planning-plant?id=${e.data.id}`, e.data, () => { this.FETCH_LIST(); });
    },
    DELETE(e) {
      DELETE_DATA(`/Md/delete-md-sap-planner-grp-planning-plant?id=${e.data.id}`, () => { this.FETCH_LIST(); });
    },
  },
};
</script>
