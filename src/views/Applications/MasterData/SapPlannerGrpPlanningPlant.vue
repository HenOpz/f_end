...
export default {
  ...
  methods: {
    ...
    CREATE(e) {
      ...
      axios({
        method: "post",
        url: "/Md/add-md-sap-planner-grp-planning-plant",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,
    ...
    UPDATE(e) {
      axios({
        method: "put",
        url: "/Md/edit-md-sap-planner-grp-planning-plant?id=" + e.data.id,
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,
    ...
    DELETE(e) {
      axios({
        method: "delete",
        url: "/Md/delete-md-sap-planner-grp-planning-plant?id=" + e.data.id,
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,
