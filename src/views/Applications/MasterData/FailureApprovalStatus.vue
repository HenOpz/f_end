...
export default {
  ...
  methods: {
    ...
    FETCH_LIST() {
      ...
      axios({
        method: "get",
        url: "/Md/get-md-failure-approval-status-list",
        headers: {
    ...
    CREATE(e) {
      ...
      axios({
        method: "post",
        url: "/Md/add-md-failure-approval-status",
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,
    ...
    UPDATE(e) {
      axios({
        method: "put",
        url: "/Md/edit-md-failure-approval-status?id=" + e.data.id,
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,
    ...
    DELETE(e) {
      axios({
        method: "delete",
        url: "/Md/delete-md-failure-approval-status?id=" + e.data.id,
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,
