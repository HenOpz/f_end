  ...
  export default {
    ...
    methods: {
      ...
      FETCH_LIST() {
        ...
        axios({
          method: "get",
          url: "/Md/get-md-ex-insp-discip-line-list",
          headers: {
      ...
      CREATE(e) {
        ...
        axios({
          method: "post",
          url: "/Md/add-md-ex-insp-discip-line",
          headers: {
            Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
          },
          data: e.data,
      ...
      UPDATE(e) {
        axios({
          method: "put",
          url: "/Md/edit-md-ex-insp-discip-line?id=" + e.data.id,
          headers: {
            Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
          },
          data: e.data,
      ...
      DELETE(e) {
        axios({
          method: "delete",
          url: "/Md/delete-md-ex-insp-discip-line?id=" + e.data.id,
          headers: {
            Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
          },
          data: e.data,
