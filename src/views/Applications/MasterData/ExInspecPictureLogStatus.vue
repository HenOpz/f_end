  ...
  export default {
    ...
    methods: {
      ...
      FETCH_LIST() {
        ...
        axios({
          method: "get",
          url: "/Md/get-md-ex-insp-pic-log-status-list",
          headers: {
      ...
      CREATE(e) {
        ...
        axios({
          method: "post",
          url: "/Md/add-md-ex-insp-pic-log-status",
          headers: {
            Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
          },
          data: e.data,
      ...
      UPDATE(e) {
        axios({
          method: "put",
          url: "/Md/edit-md-ex-insp-pic-log-status?id=" + e.data.id,
          headers: {
            Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
          },
          data: e.data,
      ...
      DELETE(e) {
        axios({
          method: "delete",
          url: "/Md/delete-md-ex-insp-pic-log-status?id=" + e.data.id,
          headers: {
            Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
          },
          data: e.data,
