...
export default {
  ...
  methods: {
    ...
    FETCH_LIST() {
      GET_DATA(this, '/Md/get-md-sap-code-grp-damage-list', 'dataList');
    },
    CREATE(e) {
      e.data.id = 0;
      POST_DATA('/Md/add-md-sap-code-grp-damage', e.data, () => { this.FETCH_LIST(); });
    },
    UPDATE(e) {
      PUT_DATA(`/Md/edit-md-sap-code-grp-damage?id=${e.data.id}`, e.data, () => { this.FETCH_LIST(); });
    },
    DELETE(e) {
      DELETE_DATA(`/Md/delete-md-sap-code-grp-damage?id=${e.data.id}`, () => { this.FETCH_LIST(); });
    },
  },
};
</script>
