    ...
    <div class="page-container">
        <div class="page-section">
            <div class="table-wrapper">
                ...
                <div span-2 class="input-wrapper">
                    <span>GHB (Cell/mL)</span>
                    <div class="input">
                        <DxNumberBox 
                            placeholder="Enter GHB" 
                            v-model="data.ghb_val" 
                        />
                    </div>
                </div>

                <div span-2 class="input-wrapper">
                    <span>APGHB (Cells/mL)</span>
                    <div class="input">
                        <DxNumberBox 
                            placeholder="Enter APGHB" 
                            v-model="data.apghb_val" 
                        />
                    </div>
                </div>
...
export default {
    name: "add-micro-bacteria-result",
    components: {
        DxSelectBox,
        // DxTextBox,
        DxNumberBox,
