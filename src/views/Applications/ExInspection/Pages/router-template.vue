...
export default {
  ...
  data() {
    return {
      ...
      routes: [
        {
          url: `/ex-inspection/tag/${this.$route.params.id_tag}/information`,
          icon: "/img/svg/pie-chart-svg.svg",
          name: 'Information'
        },
        {
          url: `/ex-inspection/tag/${this.$route.params.id_tag}/inspection-record`,
          icon: "/img/svg/window-layout-svg.svg",
          name: 'Inspection Record'
        },
        {
          url: `/ex-inspection/tag/${this.$route.params.id_tag}/checklist`,
          icon: "/img/svg/window-layout-svg.svg",
          name: 'Checklist'
        },
        {
          url: `/ex-inspection/tag/${this.$route.params.id_tag}/picture-log`,
          icon: "/img/svg/window-layout-svg.svg",
          name: 'Picture Log'
        },
      ]
