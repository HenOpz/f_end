    ...
    <div class="page-container">
        <div class="page-section">
            ...
            >
                ...
                <DxColumn 
                    data-field="id_main_workctr" 
                    caption="Main WorkCtr" 
                    alignment="center"
                >
                    <DxLookup :data-source="mainWorkCtrList" display-expr="code" value-expr="id" />
                </DxColumn>
                <DxColumn 
                ...
                <template #masterDetailTemplate="{ data }">
                    ...
                    Damage Mechanism: {{ GET_DAMAGE(data.data.id_damage_mechanism) }}<br>
                    Type of Repair: {{ GET_REPAIR_TYPE(data.data.id_repair) }}<br>
            ...
            axios({
                ...
                .then(res => {
                    if (res.status == 200 && res.data) {
                        this.gpiRecordList = res.data;
                        console.log(this.gpiRecordList);
                    }
                })
                .catch(error => {
                    console.log(error);
