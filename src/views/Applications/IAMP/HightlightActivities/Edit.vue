  ...
  methods: {
    FETCH_HIGHLIGHT_RECORD() {
      GET_DATA(this, `/HighlightActivities/${this.id_record}`, (data) => {
        this.highlightActivitiesList = data;
    ...
    UPDATE_RECORD() {
      ...
      PUT_DATA(`/HighlightActivities/${this.highlightActivitiesList.id}`, this.highlightActivitiesList, () => { this.SET_CURRENT_VIEW(0); });
    },
    DELETE_RECORD() {
      DELETE_DATA(`/HighlightActivities/delete-highlight-activities?id=${this.highlightActivitiesList.id}`, () => { this.SET_CURRENT_VIEW(0); });
    },
