  ...
  <div class="page-container">
    <div class="page-section">
      <div class="table-wrapper">
        <h3 style="grid-column: span 2; margin-bottom: 0; margin-top: 0;">New MOC</h3>
        ...
        <!-- <div class="input-wrapper" span-2>
          ...
          <div class="select">
            <DxFileUploader
              select-button-text="Select PDF"
              label-text=""
              :allowed-file-extensions="['.pdf']"
              upload-mode="useForm"
              v-model="mocList.moc_file_path"
            />
          </div>
        </div>
