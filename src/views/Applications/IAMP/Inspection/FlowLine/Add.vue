...
export default {
    ...
    created() {
        this.$store.commit("UPDATE_CURRENT_PAGENAME", {
            subpageName: "FLOWLINE INSPECTION TASK",
    ...
    data() {
        return {
            data: {
                ...
                tag_number: this.fieldData.wellhead_name,
    ...
    methods: {
        ...
        CREATE_RECORD() {
            ...
            this.data.due_insp_date = moment(this.data.due_insp_date).format("L");
        ...
        CREATE_RECORD_FM() {
            ...
            axiosFileMaker({
                method: "GET",
                url: "/Flowline/layouts/info_due_inspection/script/create_inspection_task_api?script.param=" + param,
                headers: {
