    ...
    <div class="page-container">
        <div class="page-section">
            <div class="table-wrapper">
                <h3 style="grid-column: span 2; margin-top: 0; margin-bottom: 0;">New Inspection Task</h3>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="input">
                        <DxDateBox 
                            disabled v-model="data.due_insp_date"  
                            display-format="yyyy" 
                            :read-only="true"
                        />
                    </div>
...
export default {
    ...
    created() {
        this.$store.commit("UPDATE_CURRENT_PAGENAME", {
            subpageName: "PRESSURE VESSEL INSPECTION TASK",
    ...
    data() {
        return {
            data: {
                ...
                tag_number: this.fieldData.vessel_no,
    ...
    methods: {
        ...
        CREATE_RECORD_FM() {
            const param = this.data.id_tag + '||' + this.data.it_number + '||' + this.data.plan_insp_date + '||' + this.fieldData.inspection_type + '||' + this.data.plan_manhours;
            console.log('param', param);
            axiosFileMaker({
                method: "GET",
                url: "/Vessel/layouts/info_due_inspection/script/create_inspection_task_api?script.param=" + param,
                headers: {
