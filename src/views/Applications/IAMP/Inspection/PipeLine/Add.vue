        ...
        <div class="page-section">
            <div class="table-wrapper">
                ...
                <div class="input-wrapper">
                    ...
                    <div class="input">
                        <DxTextBox :disabled="true" v-model="data.due_insp_date"  />
                    </div>
                </div>
...
export default {
    ...
    created() {
        this.$store.commit("UPDATE_CURRENT_PAGENAME", {
            subpageName: "PIPELINE INSPECTION TASK",
    ...
    methods: {
        ...
        CREATE_RECORD_FM() {
            ...
            axiosFileMaker({
                method: "GET",
                url: "/Pipeline/layouts/info_pipeline_due_inspection/script/create_pipeline_inspection_task_api?script.param=" + param,
                headers: {
