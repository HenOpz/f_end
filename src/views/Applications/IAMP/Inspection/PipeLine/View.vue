        ...
        <div class="page-section">
            <div class="table-wrapper">
                ...
                >
                    ...
                    />
                    <DxColumn 
                        data-field="fieldData.info::pipeline_status"
...
export default {
    ...
    created() {
        this.$store.commit("UPDATE_CURRENT_PAGENAME", {
            subpageName: "INSPECTION DUE PIPELINE",
    ...
    methods: {
        ...
        FETCH_FILE_MAKER_RECORD() {
            ...
            axiosFileMaker({
                method: "GET",
                url: "/Pipeline/layouts/info_pipeline_due_inspection/records?_limit=10000",
                headers: {
                    "Content-Type": "application/json",
                ...
                .then(res => {
                    this.pipelineList = res.data.response.data;
        ...
        onCellPrepared(e) {
            if(e.rowType === "data" && e.column.dataField === "fieldData.info::pipeline_status") {
                console.log(e.data.fieldData);
                e.cellElement.style.backgroundColor = this.GET_STATUS_COLOR(e.data.fieldData["info::pipeline_status"]);
