        ...
        <div class="input-wrapper">
          ...
          <div class="select">
            <DxTextBox
              ...
              :disabled="!btn_state"
              v-model="longTermRecordList.id_failure"
            />
          </div>
        </div>
        ...
        <div class="input-wrapper">
          ...
          <div class="input">
            <DxDateBox
              type="date"
              :disabled="!btn_state"
              v-model="longTermRecordList.action_date"
            />
          </div>
        </div>
        ...
        <div class="input-wrapper">
          ...
          <div class="select">
            <DxSelectBox
              ...
              :disabled="!btn_state"
              v-model="longTermRecordList.id_discipline"
            />
          </div>
        </div>
        ...
        <div class="input-wrapper">
          ...
          <div class="select">
            <DxSelectBox
              ...
              :disabled="!btn_state"
              v-model="longTermRecordList.id_failure_action_status"
            />
          </div>
        </div>
        ...
        <div class="input-wrapper" fill>
          ...
          <div class="input">
            <DxTextArea
              ...
              :disabled="!btn_state"
              v-model="longTermRecordList.action_details"
            />
          </div>
        </div>
...
export default {
  ...
  created() {
    this.$store.commit("UPDATE_CURRENT_PAGENAME", {
      subpageName: "LTT NUMBER: " + this.id_record,
  ...
  methods: {
    FETCH_LONG_TERM_RECORD() {
      GET_DATA(this, `/FailureActionRecord/${this.id_record}`, 'longTermRecordList');
    },
    UPDATE_RECORD() {
      if (this.longTermRecordList.action_date)
        this.longTermRecordList.action_date = moment(this.longTermRecordList.action_date).format("L");
      PUT_DATA(`/FailureActionRecord/${this.longTermRecordList.id}`, this.longTermRecordList, () => { this.longTermRecordList });
    },
    DELETE_RECORD() {
      DELETE_DATA(`/FailureActionRecord/delete-failure-action-record?id=${this.longTermRecordList.id}`, () => { this.SET_CURRENT_VIEW(0); });
    },
    FETCH_DISCIPLINE() {
