...
export default {
  ...
  methods: {
    FETCH_LONG_TERM_RECORD() {
      GET_DATA(this, `/RCFAActionRecord/${this.id_record}`, 'longTermRecordList');
    },
    UPDATE_RECORD() {
      ...
      PUT_DATA(`/RCFAActionRecord/${this.longTermRecordList.id}`, this.longTermRecordList, () => { this.longTermRecordList });
    },
    DELETE_RECORD() {
      DELETE_DATA(`/RCFAActionRecord/delete-พแดฟ-action-record?id=${this.longTermRecordList.id}`, () => { this.SET_CURRENT_VIEW(0); });
    },
    FETCH_DISCIPLINE() {
