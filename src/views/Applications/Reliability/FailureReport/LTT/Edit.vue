    ...
    <div class="page-container">
        <div class="page-section">
            <div class="table-wrapper">
                <h4 style="">Edit Short Term Tracking</h4>
                <div class="scroll">
                    <div
                        class="input-wrapper"
                        fill
...
export default {
    ...
    created() {
        ...
        this.FETCH_PLATFORM();
        this.FETCH_FAILURE_ACTION_RECORD();
    },
    data() {
        return {
    ...
    methods: {
        FETCH_FAILURE_ACTION_RECORD() {
            ...
            GET_DATA(
                this,
                `/FailureActionRecord/${this.id_record}`,
                (data1) => {
                    this.failureActionRecordList = data1;
                    GET_DATA(
                        this,
                        `/SapHeader/get-sap-header-by-module-from-module?id_module=2&id_from_module=${this.id_record}`,
                        (data2) => {
                            console.log("SapHeader", data2);
                            this.sapHeader = data2[0];
                            this.sapHeader.descriptionI =
                                this.sapHeader.description;
                            if (this.sapHeader.required_end_date) {
                                const y =
                                    this.sapHeader.required_end_date.substring(
                                        0,
                                        4
                                    );
                                const m =
                                ...
                                this.sapHeader.required_end_date = new Date(
                                    y,
                                    m,
                                    d
                                );
                            ...
                            if (this.sapHeader.required_start_date) {
                                const y =
                                    this.sapHeader.required_start_date.substring(
                                        0,
                                        4
                                    );
                                const m =
                                ...
                                this.sapHeader.required_start_date = new Date(
                                    y,
                                    m,
                                    d
                                );
                            ...
                            if (this.sapHeader.required_start_time) {
                                this.sapHeader.required_start_time = moment(
                                    this.sapHeader.required_start_time,
                                    ["HHmmss"]
                                ).format("lll");
                                console.log(this.sapHeader.required_start_time);
                            }
                            if (this.sapHeader.required_end_time) {
                                this.sapHeader.required_end_time = moment(
                                    this.sapHeader.required_end_time,
                                    ["HHmmss"]
                                ).format("lll");
        ...
        UPDATE_RECORD() {
            ...
            PUT_DATA(
                `/FailureActionRecord/${this.failureActionRecordList.id}`,
                this.failureActionRecordList,
                () => {
                    this.sapHeader.reported_by = "AIMS";
                    this.sapHeader.description = (
                        this.sapHeader.id_reference +
                        "-" +
                        this.sapHeader.equipment_no +
                        "-" +
                        this.failureActionRecordList.action_details
                    ).substring(0, 41);
        ...
        DELETE_RECORD() {
            DELETE_DATA(
                `/FailureActionRecord/delete-failure-action-record?id=${this.failureActionRecordList.id}`,
                () => {
