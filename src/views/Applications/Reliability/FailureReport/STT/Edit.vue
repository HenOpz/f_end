...
export default {
    ...
    methods: {
        FETCH_FAILURE_ACTION_RECORD() {
            ...
            GET_DATA(this, `/FailureActionRecord/${this.id_record}`, (data) => {
                this.failureActionRecordList = data;
                GET_DATA(
                    this,
                    `/SapHeader/get-sap-header-by-module-from-module?id_module=2&id_from_module=${this.id_record}`,
                    (data) => {
                        console.log("SapHeader", data);
                        this.sapHeader = data[0];
