            ...
            <div class="table-wrapper">
                ...
                >
                    <DxEditing
                        ...
                        :allow-adding="user.failureRecordAuths[0].seq  === 1"
                        :use-icons="true"
                        mode="popup"
                    />
                    ...
                    <DxColumn
                        data-field="fl_number"
                        caption="FR No."
                        :width="90"
                        alignment="center"
                    />
                    <DxColumn
                        data-field="findings_date"
                    ...
                    <template #action-cell-template="{ data }">
                        <div class="action-wrapper">
                            ...
                            <div
                                v-if="user.failure_seq === 1"
                                @click="DELETE_RECORD(data)"
                            >
                                <img
...
export default {
    ...
    created() {
        ...
        if (this.$store.state.status.server == true) {
            ...
            // this.user.failureRecordAuths[0].seq = 1;
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        FETCH_FAILURE_RECORD() {
            GET_DATA(this, "/FailureRecord", "failureRecordList");
        },
        DELETE_RECORD(e) {
            this.$ons.notification
                ...
                .then((res) => {
                    if (res == 1) {
                        DELETE_DATA(
                            `/FailureRecord/delete-failure-record?id=${e.key}`,
                            () => {
                                this.FETCH_FAILURE_RECORD();
                            }
                        );
