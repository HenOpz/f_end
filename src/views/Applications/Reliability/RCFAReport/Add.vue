        ...
        <div class="input-wrapper">
          ...
          <div class="input">
            <DxTextBox
              ...
              :disabled="failureRecordList.id_cof_environment === null"
            />
          </div>
        </div>
        ...
        <div class="input-wrapper">
          ...
          <div class="input">
            <DxTextBox
              ...
              :disabled="failureRecordList.id_cof_production_loss === null"
            />
          </div>
        </div>
        ...
        <div class="input-wrapper">
          ...
          <div class="input">
            <DxTextBox
              ...
              :disabled="failureRecordList.id_cof_reputation === null"
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    CREATE_RECORD(e) {
      ...
      console.log(e.data);
      POST_DATA('/FailureRecord', this.failureRecordList, (data) => { this.SET_CURRENT_VIEW(2, data); });
    },
    FETCH_RISK_MATRIX() {
      const numbers = [
