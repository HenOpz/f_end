  ...
  <div class="page-container">
    <div class="page-section">
      <div class="table-wrapper">
        <h4 style="grid-column: span 4">Edit Short Term Tracking</h4>
...
export default {
  ...
  methods: {
    FETCH_FAILURE_ACTION_RECORD() {
      ...
      GET_DATA(this, `/RCFAActionRecord/${this.id_record}`, (data) => {
        this.failureActionRecordList = data;
        GET_DATA(this, `/SapHeader/get-sap-header-by-module-from-module?id_module=2&id_from_module=${this.id_record}`, (data) => {
    ...
    UPDATE_RECORD() {
      ...
      console.log('failureActionRecordList', this.failureActionRecordList);
      ...
      PUT_DATA(`/RCFAActionRecord/${this.failureActionRecordList.id}`, this.failureActionRecordList, () => {
    ...
    DELETE_RECORD() {
      DELETE_DATA(`/RCFAActionRecord/delete-rcfa-action-record?id=${this.failureActionRecordList.id}`, () => { this.SET_CURRENT_VIEW(2); });
    },
