  ...
  <div class="page-container">
    <div class="page-section">
      <div class="table-wrapper">
        <h4 style="grid-column: span 4">New Short Term Tracking</h4>
...
export default {
  ...
  methods: {
    CREATE_RECORD() {
      ...
      POST_DATA('/RCFAActionRecord', this.failureActionRecordList, (data) => {
    ...
    FETCH_PLATFORM() {
      GET_DATA(this, '/Md/get-md-platform-list', 'sapHeader.planner_grp_planning_plant');
    },
    ...
    ON_MAIN_WORKCTR_CHANGED(e) {
      console.log(e);
      const pg = this.formSelect.mainWorkCtr.filter(m => m.code == e.value);
