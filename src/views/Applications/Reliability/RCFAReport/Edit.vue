                ...
                <div class="table-wrapper">
                    ...
                    >
                        <div fill>
                            ...
                            >
                                <label class="hd">RCFA Attachment</label>
                            </div>
                            <DxDataGrid
                                id="data-grid-list"
                                key-expr="id"
                        ...
                        <div fill style="margin-top: 10px;">
                            <div
                                class="table-header-toolbar left"
                                style="width: calc(100% - 231px)"
                            >
                            ...
                            >
                                ...
                                <template
                                    #masterShorttermDetailTemplate="{ data }"
                                >
                                    <SapSTT :sapData="data" />
                                </template>
                        ...
                        <div fill style="margin-top: 10px;">
                            ...
                            >
                                ...
                                <template
                                    #masterLongtermDetailTemplate="{ data }"
                                >
                                    <SapLTT :sapData="data" />
                                </template>
...
export default {
    ...
    methods: {
        FETCH_FAILURE_RECORD() {
            GET_DATA(
                this,
                `/FailureRecord/get-failure-record-by-id-is-rcfa?id=${this.id_record}`,
                "failureRecordList",
                () => {
        ...
        FETCH_SHORT_TERM_RECORD() {
            GET_DATA(
                this,
                `/RCFAActionRecord/get-rcfa-action-record-short-term-by-id?id_failure=${this.failureRecordList.id}`,
                "shortTermRecordList"
            );
        },
        FETCH_LONG_TERM_RECORD() {
            GET_DATA(
                this,
                `/RCFAActionRecord/get-rcfa-action-record-long-term-by-id?id_failure=${this.failureRecordList.id}`,
                "longTermRecordList"
            );
        },
        FETCH_RISK_MATRIX() {
        ...
        DELETE_FAILURE_ACTION_RECORD(e) {
            this.$ons.notification
                ...
                .then((res) => {
                    if (res == 1) {
                        DELETE_DATA(
                            `/RCFAActionRecord/delete-rcfa-action-record?id=${e.key}`,
                            () => {
                                this.FETCH_SHORT_TERM_RECORD();
                                this.FETCH_LONG_TERM_RECORD();
                            }
        ...
        FETCH_LIBRARY() {
            GET_DATA(
                this,
                `/RCFAFile/get-rcfa-file-by-id?id=${this.id_record}`,
                "library"
            );
        },
        ...
        ADD_NEW_FILE(e) {
            ...
            POST_DATA("/RCFAFile", formData, true, () => {
                this.FETCH_LIBRARY();
            });
        },
        UPDATE_DOC(e) {
